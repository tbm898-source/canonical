// experimental v2 clone: tests whether GitHub-sync deploys brand-new functions
// when the original is stuck as a 404 ghost. Read-only — same shape as
// getCanonicalProgramFull, different name only.
